...
// RequestCertificateParams contains all the bound params for the request certificate operation
// typically these are obtained from a http.Request
//
// swagger:parameters requestCertificate
...
//
// To ensure default values, the struct must have been initialized with NewRequestCertificateParams() beforehand.
func (o *RequestCertificateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
